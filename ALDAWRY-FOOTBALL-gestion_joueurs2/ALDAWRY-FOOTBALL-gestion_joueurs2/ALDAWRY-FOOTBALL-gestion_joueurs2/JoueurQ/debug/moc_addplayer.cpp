...
constexpr auto qt_meta_stringdata_CLASSAddPlayerENDCLASS = QtMocHelpers::stringData(
    "AddPlayer",
    "on_addButton_clicked",
    "",
    "on_toolButtonImage_clicked"
);
...
Q_CONSTINIT const QMetaObject AddPlayer::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddPlayerENDCLASS_t,
        ...
        // method 'on_toolButtonImage_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void AddPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_toolButtonImage_clicked(); break;
        default: ;
        }
    }
    (void)_a;
