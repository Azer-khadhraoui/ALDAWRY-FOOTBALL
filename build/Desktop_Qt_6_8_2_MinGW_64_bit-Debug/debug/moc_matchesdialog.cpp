...
static constexpr auto qt_meta_stringdata_ZN13MatchesDialogE = QtMocHelpers::stringData(
    "MatchesDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13MatchesDialogE[] = {
...
Q_CONSTINIT const QMetaObject MatchesDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13MatchesDialogE.offsetsAndSizes,
    qt_meta_data_ZN13MatchesDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13MatchesDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *MatchesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13MatchesDialogE.stringdata0))
