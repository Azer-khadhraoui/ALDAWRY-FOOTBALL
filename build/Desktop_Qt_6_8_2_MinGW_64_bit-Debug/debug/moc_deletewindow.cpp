...
static constexpr auto qt_meta_stringdata_ZN12deletewindowE = QtMocHelpers::stringData(
    "deletewindow",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12deletewindowE[] = {
...
Q_CONSTINIT const QMetaObject deletewindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12deletewindowE.offsetsAndSizes,
    qt_meta_data_ZN12deletewindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12deletewindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *deletewindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12deletewindowE.stringdata0))
