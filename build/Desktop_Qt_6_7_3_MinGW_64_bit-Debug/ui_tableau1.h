...
"}"));
        ...
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/compimg/search.png")));
...
"    border-radius: 1px;"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/compimg/editIcon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"    border-radius: 1px;"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/compimg/deleteIcon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"    border-radius: 1px;"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/compimg/generate.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"    border-radius: 1px;"));
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/compimg/StartDate.png")));
...
"background-color: transparent;"));
        ...
        label_4->setPixmap(QPixmap(QString::fromUtf8(":/compimg/PREDICTION.png")));
