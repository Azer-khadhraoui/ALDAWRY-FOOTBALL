...
public:
    ...
    void setupUi(QWidget *displaymatch_coach)
    {
        ...
        displaymatch_coach->resize(725, 644);
        ...
        search = new QLineEdit(displaymatch_coach);
...
"color: rgb(24, 24, 24);\n"
""));
        label_3 = new QLabel(displaymatch_coach);
...
"}"));
        allmatches = new QTableView(displaymatch_coach);
