...
#include "../../../compheaders/statistics2.h"
...
struct qt_meta_stringdata_CLASSstatistics2ENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSstatistics2ENDCLASS = QtMocHelpers::stringData(
    "statistics2",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSstatistics2ENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject statistics2::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSstatistics2ENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSstatistics2ENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSstatistics2ENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<statistics2, std::true_type>,
...
void *statistics2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSstatistics2ENDCLASS.stringdata0))
