...
struct qt_meta_stringdata_CLASSAddTodoDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAddTodoDialogENDCLASS = QtMocHelpers::stringData(
    "AddTodoDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAddTodoDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AddTodoDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAddTodoDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAddTodoDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddTodoDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AddTodoDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAddTodoDialogENDCLASS.stringdata0))
