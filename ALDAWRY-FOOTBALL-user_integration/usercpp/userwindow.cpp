...
#include "../userheaders/mainwindow.h" // Add this line to include MainWindow definition
...
UserWindow::UserWindow(MainWindow *parent) : QMainWindow(parent), ui(new Ui::MainWindow), mainWindowParent(parent) {
    ...
    //connect(ui->logout, &QPushButton::clicked, this, &UserWindow::on_pushButton_clicked); // New connection for sign-out
