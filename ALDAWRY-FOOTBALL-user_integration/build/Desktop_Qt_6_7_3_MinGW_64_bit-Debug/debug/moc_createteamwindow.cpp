...
struct qt_meta_stringdata_CLASSCreateTeamWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCreateTeamWindowENDCLASS = QtMocHelpers::stringData(
    "CreateTeamWindow",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCreateTeamWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CreateTeamWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCreateTeamWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCreateTeamWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCreateTeamWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CreateTeamWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCreateTeamWindowENDCLASS.stringdata0))
