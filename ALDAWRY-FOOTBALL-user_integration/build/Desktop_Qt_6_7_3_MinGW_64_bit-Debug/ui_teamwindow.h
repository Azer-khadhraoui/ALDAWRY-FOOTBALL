...
"}"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/img/ai.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"background-color: #D9CEBD;"));
        ...
        label_6->setPixmap(QPixmap(QString::fromUtf8(":/img/Group 2or.png")));
...
"}"));
        ...
        label_15->setPixmap(QPixmap(QString::fromUtf8(":/img/Layer 2.png")));
...
"color:white;"));
        ...
        label_17->setPixmap(QPixmap(QString::fromUtf8(":/img/pic.png")));
...
"}"));
        ...
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/img/BALL.png")));
...
"}"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/img/pencil.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/img/List.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"}"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/img/delete.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"}"));
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/img/add.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/img/minus.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
